...
def build_canonical_metrics(
    ...
    metrics = {
        ...
        "task.proof_validity_score": float(extra.get("task.proof_validity_score", task_validity_score)),
        "task.document_grounding_score": float(extra.get("task.document_grounding_score", 0.0)),
        ...
        "rep.document.parse_completeness": float(extra.get("rep.document.parse_completeness", 0.0)),
        "rep.symbol.binding_error_rate": float(extra.get("rep.symbol.binding_error_rate", 0.0)),
        "rep.diagram.grounding_score": float(extra.get("rep.diagram.grounding_score", 0.0)),
        "rep.constraint.coverage": float(extra.get("rep.constraint.coverage", 0.0)),
        ...
        "proc.frontier.branch_quality": float(extra.get("proc.frontier.branch_quality", 0.0)),
        "proc.strategy.consistency": float(extra.get("proc.strategy.consistency", 0.0)),
        ...
        "search.backtrack_rate": float(extra.get("search.backtrack_rate", 0.0)),
        "search.recovery_precision": float(extra.get("search.recovery_precision", 0.0)),
        ...
        "mem.applicability_precision": float(extra.get("mem.applicability_precision", 0.0)),
        "mem.applicability_reject_rate": float(extra.get("mem.applicability_reject_rate", 0.0)),
        ...
        "abs.invariant.reuse_rate": float(extra.get("abs.invariant.reuse_rate", 0.0)),
        ...
        "eval.counterexample_hit_rate": float(extra.get("eval.counterexample_hit_rate", 0.0)),
        "eval.disagreement": float(extra.get("eval.disagreement", 0.0)),
        "concept.leakage_score": float(extra.get("concept.leakage_score", 0.0)),
        "concept.isolation_score": float(extra.get("concept.isolation_score", 0.0)),
        "paired.invariance.gap": float(extra.get("paired.invariance.gap", 0.0)),
        "paired.asymmetry_rate": float(extra.get("paired.asymmetry_rate", 0.0)),
        "benchmark.tier1.weight": float(extra.get("benchmark.tier1.weight", 0.0)),
        "benchmark.tier2.generalization_gap": float(extra.get("benchmark.tier2.generalization_gap", 0.0)),
        "benchmark.tier3.frontier_success_rate": float(extra.get("benchmark.tier3.frontier_success_rate", 0.0)),
        "contam.train_visible_overlap_rate": float(extra.get("contam.train_visible_overlap_rate", 0.0)),
        "contam.strict_holdout_leakage_score": float(extra.get("contam.strict_holdout_leakage_score", 0.0)),
        "provenance.parser_coverage": float(extra.get("provenance.parser_coverage", 0.0)),
        "provenance.formalizer_coverage": float(extra.get("provenance.formalizer_coverage", 0.0)),
        "provenance.verifier_coverage": float(extra.get("provenance.verifier_coverage", 0.0)),
