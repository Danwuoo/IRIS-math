...
Final acceptance is resolved through the active task adjudication policy in `docs/17_Runtime_and_Task_Adjudication_Semantics.md`; verifier evidence is the decisive evidence surface, not a freestanding substitute for adjudication policy.
