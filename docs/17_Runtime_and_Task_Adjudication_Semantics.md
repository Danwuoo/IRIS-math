...
Unless a stricter policy is declared, `required_evidence_classes` must satisfy the minimum task-family evidence bundle in `docs/14_Verifier_and_Formalization_Stack.md`.
