...
- Treat benchmark rows below as posture summaries, not exceptions to the family-specific Tier 1 / Tier 2 / Tier 3 firewalls in `docs/13_Benchmark_Registry_and_Tiering_Playbook.md`.
- Treat outcome claims as invalid if they violate the success-model red lines in `docs/11_Goals_and_Success_Criteria.md`.
...
5. verifier-maturity evidence sufficient for the claimed profile boundary, including the frontier hard-gate surfaces from `docs/14_Verifier_and_Formalization_Stack.md` when relevant,
